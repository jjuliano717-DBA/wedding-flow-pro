...
import { Menu, X, Heart, Search, User, LogOut, Briefcase } from "lucide-react";
              ...
              <SheetContent side="left" className="w-[300px] sm:w-[350px] p-0 flex flex-col">
                  ...
                  {!isAuthenticated ? (
                    <div className="flex gap-2">
                      ...
                      <Link to="/auth?mode=signup" className="flex-1">
                        <Button variant="champagne" className="w-full">Join Free</Button>
                      </Link>
                    </div>
                  ) : (
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        <span className="font-bold text-lg leading-none">{user?.fullName}</span>
                ...
                <div className="flex-1 overflow-y-auto py-4">
                  <nav className="flex flex-col space-y-1">
                    {isAuthenticated && (
                      <Link to={user?.role === 'business' ? "/business" : "/planner"} className="flex items-center gap-4 px-6 py-3 text-foreground hover:bg-slate-50 active:bg-slate-100 transition-colors">
                    ...
                    <Link to="/style-matcher" className="flex items-center gap-4 px-6 py-3 text-foreground hover:bg-slate-50 active:bg-slate-100 transition-colors">
                ...
                {isAuthenticated && (
                  <div className="p-4 border-t space-y-2">
                    ...
                    <Button variant="ghost" onClick={logout} className="w-full justify-start gap-4 h-12 text-red-500 hover:text-red-600 hover:bg-red-50">
