            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex gap-4">
                <div className="relative flex-1 md:w-48">
                  ...
                  <select className="w-full h-12 pl-12 pr-4 rounded-lg bg-muted border-0 text-foreground appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary/50">
